...
//echo $password = 1234;
//echo '<br>';
//echo $password_confirm = 1234;
//echo '<br>';
//echo $test2 = strcmp($password, $password_confirm);//string compare output true(0) or false(1)
//exit();
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    } else if (strlen($username) < 6 || strlen($username) > 16){//less < 6 more || less > 16 more
